...
async function funcCompile(sourcePath) {
    // Parameters
    let files = [];
    files.push(path_1.default.resolve(__dirname, '..', '..', 'stdlib', 'stdlib.fc'));
    ...
    try {
        ...
        const callbackPtr = trackPointer(mod.addFunction((_kind, _data, contents, error) => {
            ...
            if (kind === 'realpath') {
                ...
                try {
                    let source = fs_1.default.readFileSync(data, 'utf-8');
