...
import { FunctionDescription, ReceiverDescription, TypeDescription, TypeRef } from "../../types/types";
import { WriterContext } from "../Writer";
export declare function writeCastedExpression(expression: ASTExpression, to: TypeRef, ctx: WriterContext): string;
export declare function unwrapExternal(targetName: string, sourceName: string, type: TypeRef, ctx: WriterContext): void;
...
export declare function writeGetter(f: FunctionDescription, ctx: WriterContext): void;
